        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center ">
          ...
          <div className="w-full md:w-1/2 md:pl-12 mt-8 md:mt-0">
            ...
            <p className="text-gray-300 mt-4">
              ...
              hair styles to suit your preferences. Whether you're looking for a
              trendy haircut, a classic updo, or a special occasion hairstyle,
              we have the expertise to bring your vision to life. With a keen
              eye for detail and a deep understanding of hair textures and face
              shapes, we'll work with you to achieve a personalized and
              flattering style that complements your individuality.
            </p>
            ...
            >
              ...
              <strong className="relative z-10 text-l">Book Appointment</strong>
            </button>
          </div>
        </div>
      </div>
